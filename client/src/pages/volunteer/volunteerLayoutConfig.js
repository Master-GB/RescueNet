...
import { ClipboardList, HandHelping, Heart, LayoutDashboard, MapPinned, MessageCircle, UserCircle, Home } from "lucide-react";
...
export const volunteerSidebarItems = [
  ...
  { name: "Team Channel", icon: MessageCircle, path: "/volunteer/chat" },
