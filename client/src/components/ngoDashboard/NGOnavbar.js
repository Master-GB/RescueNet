...
const NGOnavbar = ({ ngoData, handleStatusToggle }) => {
  ...
  return (
    <nav className="bg-[#151316] text-[#e7e1e5] px-8 py-4 flex items-center justify-between z-40 sticky top-0 border-b border-[#201e23]">
      {/* Logo */}
      <div className="flex items-center font-bold text-xl text-[#e7e1e5] tracking-tight">
